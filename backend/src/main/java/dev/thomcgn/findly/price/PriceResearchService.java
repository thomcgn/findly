...
public class PriceResearchService {
    ...
    public List<PriceSource> findComparablePrices(Analysis analysis) {
        BigDecimal listingPrice = analysis.getListing() != null ? analysis.getListing().getListingPrice() : BigDecimal.ZERO;
        ...
        sources.add(PriceSource.builder()
                .analysis(analysis)
                .sourceName("Marktvergleich")
                .productTitle(analysis.getListing() != null ? analysis.getListing().getTitle() : "Produkt")
                .price(lower.setScale(2, java.math.RoundingMode.HALF_UP))
                .currency("EUR")
                .url(analysis.getListing() != null ? analysis.getListing().getExternalUrl() : "https://example.com")
